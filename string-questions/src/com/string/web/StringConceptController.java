package com.string.web;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class StringConceptController {

	private StringConceptController(Object o) {
		System.out.println("Object");
	}

	private StringConceptController(Integer i) {
		System.out.println("Integer");
	}

	public static void main(String[] args) {

		// call Integer method because overload methods call subClass of
		// class so, here Integer is subclass of Object class
		new StringConceptController(null); // print Integer
